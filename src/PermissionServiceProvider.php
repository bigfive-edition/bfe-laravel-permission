...
class PermissionServiceProvider extends ServiceProvider
{
    ...
    protected function registerBladeExtensions($bladeCompiler)
    {
        $bladeCompiler->directive('role', function ($arguments) {
            return "<?php if(\\Bfe\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasRole', {$arguments})): ?>";
        });
        $bladeCompiler->directive('elserole', function ($arguments) {
            return "<?php elseif(\\Bfe\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasRole', {$arguments})): ?>";
        });
        ...
        $bladeCompiler->directive('hasanyrole', function ($arguments) {
            return "<?php if(\\Bfe\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasAnyRole', {$arguments})): ?>";
        });
        ...
        $bladeCompiler->directive('hasallroles', function ($arguments) {
            return "<?php if(\\Bfe\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasAllRoles', {$arguments})): ?>";
        });
        ...
        $bladeCompiler->directive('hasexactroles', function ($arguments) {
            return "<?php if(\\Bfe\\Permission\\PermissionServiceProvider::bladeMethodWrapper('hasExactRoles', {$arguments})): ?>";
        });
