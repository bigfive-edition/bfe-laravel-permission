...
trait HasRoles
{
     ...
     * @param string|int|array|\Bfe\Permission\Contracts\Role|\Illuminate\Support\Collection $roles
     * @param string $guard
     *
     ...
     *
     * @param array|string|int|\Bfe\Permission\Contracts\Role|\Illuminate\Support\Collection ...$roles
     *
     * @return $this
     */
     ...
     *
     * @param string|int|\Bfe\Permission\Contracts\Role $role
     */
     ...
     *
     * @param  array|\Bfe\Permission\Contracts\Role|\Illuminate\Support\Collection|string|int  ...$roles
     *
     * @return $this
     */
     ...
     *
     * @param  string|array|\Bfe\Permission\Contracts\Role|\Illuminate\Support\Collection  $roles
     * @param  string|null  $guard
     * @return bool
     */
